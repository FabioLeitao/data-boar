...
if ($pendingCount -eq 0) {
    ...
    $folders = @("feedbacks_and_reviews", "homelab", "author_info", "commercial", "operator_economics", "ictsi_dossie", "raw_pastes", "plans", "pitch")
...
if ($Push) {
    ...
    if (-not $labRemotes) {
        ...
        Write-Warn "  git -C docs/private remote add lab-latitude ssh://leitao@latitude/home/leitao/Documents/.kb-cache/repos/notes-sync.git"
        Write-Warn "  git -C docs/private remote add lab-mini-bt  ssh://leitao@mini-bt/home/leitao/Documents/.kb-cache/repos/notes-sync.git"
        Write-Warn "  git -C docs/private remote add lab-t14      ssh://leitao@t14-leitao/home/leitao/Documents/.kb-cache/repos/notes-sync.git"
    } else {
