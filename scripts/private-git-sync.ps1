...
if ($Push) {
    ...
    if (-not $labRemotes) {
        ...
        Write-Warn "  git -C docs/private remote add lab-lab-node-02 ssh://<user>@<lab-host-1>/home/user/Documents/.kb-cache/repos/notes-sync.git"
        ...
        Write-Warn "  git -C docs/private remote add lab-lab-node-01      ssh://<user>@<lab-host-3>/home/user/Documents/.kb-cache/repos/notes-sync.git"
    } else {
