...
# --- 4. Push (opcional) ---
if ($Push) {
    Write-Header "Passo 3: Push para lab-lab-node-02"
    ...
    if ($remote) {
        ...
        Write-Warn "Nenhum remote configurado no private repo. Configure com: git -C docs/private remote add lab-lab-node-02 <url>"
    }
}
