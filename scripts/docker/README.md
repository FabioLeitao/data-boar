...
| Script                                                                 | Purpose                                                                                                                                             |
| ------                                                                 | -------                                                                                                                                             |
| [../docker-hub-pull.ps1](../docker-hub-pull.ps1)                       | `docker pull` **fabioleitao/data_boar:latest**, **:\<semver from pyproject.toml\>**, and **previous patch** (e.g. 1.7.1 → 1.7.0) for cache and A/B. |
