...
echo "NOTE: tmux uses non-login bash — after baseline, /etc/bash.bashrc should include PATH for /usr/local/bin (role lab-node-01_bitwarden_cli). Open a new pane or: source /etc/bash.bashrc"
