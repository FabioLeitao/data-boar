...
def extract_fields(raw_text: str, pdf_path: Path) -> dict:
    ...
    return {
        ...
        "linkedin_url": f"https://www.example.com/profile/redacted)}"
        if linkedin_match
        else None,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        ...
        epilog="Exemplo: uv run python scripts/extract_cv_pdf.py docs/private/team_info/Contributor-A.pdf --json",
    )
