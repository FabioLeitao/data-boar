...
.DESCRIPTION
  ...
  em minusculas (ex.: FELIPPE_FERRAO -> felippe_ferrao_2026_v2).
...
function Get-SlugFromName {
    param([string]$Name)
    # ATS_SLI_RECOMMENDATIONS_FELIPPE_FERRAO_2026_v2.en.docx -> felippe_ferrao_2026_v2
    # ATS_SLI_RECOMMENDATIONS_FELIPPE_FERRAO_2026_v2_INDEX.md -> felippe_ferrao_2026_v2
