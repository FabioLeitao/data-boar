...
.EXAMPLE
    .\scripts\evidence-hash-manifest.ps1 -RootPath "docs\private\employers\incomm\artifacts" `
        -OutFile "docs\private\employers\incomm\integrity\MANIFEST-SHA256-2026-04-09.txt"
#>
param(
