...
switch ($Mode) {
    { $_ -in "status","dashboard" } {
        ...
        Write-Info "Plano Sulamerica (employer plan, until 2025) | Corporate-Entity-B Payments (2026+, confirmar)"
    ...
    "opex" {
        ...
        Write-Money "Plano de Saude"         "? (Corporate-Entity-B Payments 2026)"
    ...
    "capex" {
        ...
        Write-Info "Equipamentos UniFi (LAB-ROUTER-01 + switches): em producao"
    ...
    "health" {
        ...
        Write-Info "2026+:     Confirmar Corporate-Entity-B Payments"
    }
