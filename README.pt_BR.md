...
> **Release atual:** **1.7.2+safe** (PEP 440). **Docker Hub:** **`fabioleitao/data_boar:v1.7.2-safe`** ou **`latest`**. Resumo: [CHANGELOG.md](CHANGELOG.md). Notas: [docs/releases/1.7.2-safe.md](docs/releases/1.7.2-safe.md) e [Releases no GitHub](https://github.com/FabioLeitao/data-boar/releases).
