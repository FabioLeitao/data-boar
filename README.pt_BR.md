...
> **Última release estável:** **1.7.0** (Docker Hub + GitHub). **Pré-release em `main`:** **1.7.1-beta** — i18n do dashboard (`/{locale}/…`) e `enterprise_surface` em status/health; **não** equivale à **1.7.0** publicada para quem usa só a imagem estável. Resumo: [CHANGELOG.md](CHANGELOG.md). Notas: [docs/releases/](docs/releases/) e [Releases no GitHub](https://github.com/FabioLeitao/data-boar/releases) (tags estáveis).
