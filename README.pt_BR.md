...
**Roadmap:** Seguimos ampliando a **descoberta** (arquivos e mídia mais ricos, conectores em **nuvem** e **enterprise**), melhorando **alertas** ao fim da varredura e mantendo **segurança e dependências** em dia. A **cobertura de idiomas** na interface e na documentação, e as **amostras regionais** de conformidade, crescem **aos poucos**, conforme a demanda — não todos os mercados de uma vez. ***Jurisdiction hints* opcionais** (notas para DPO na planilha Report info a partir de sinais só em **metadados** — **não** conclusão jurídica) ajudam equipes multinacionais a **priorizar revisão com assessoria**; veja **[Conformidade e jurídico](docs/COMPLIANCE_AND_LEGAL.pt_BR.md)** e **[USAGE.pt_BR](docs/USAGE.pt_BR.md)**. **Para conselho e auditoria:** a narrativa permanece **legível para executivos** — dá para apontar **direção e evidências** sobre visibilidade de dados e postura de conformidade sem pedir que stakeholders mergulhem num roadmap só de engenharia. Para normas (ex.: ISO 27701, SOC 2), perfis de amostra sobre **menores**, planos de SBOM, sinais de saúde da API e o que já está entregue vs em fases, veja **[Conformidade e jurídico](docs/COMPLIANCE_AND_LEGAL.pt_BR.md)** e **[docs/releases/](docs/releases/)** — o detalhe fica ali para esta seção continuar legível para compras e jurídico.
