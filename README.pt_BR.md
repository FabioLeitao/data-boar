...
**Saúde nos EUA (HIPAA / HITECH / H.R. 7898):** A linguagem **HIPAA** embutida apoia **inventário técnico** de possível exposição de **PHI/ePHI** — **não** análise automática de violação (*breach*), contagem para notificação, fluxos de resposta ao **HHS/OCR** nem certificação de *safe harbor* / *recognized security practices* sob a **P.L. 116-321**. Alcance e limites: [Conformidade e jurídico](docs/COMPLIANCE_AND_LEGAL.pt_BR.md).
