...
| ---------- | ---- | -------- |
| **API Network Integration** | `.env` em `docs/private/homelab/` (ex.: `.env.api.LAB-ROUTER-01-se.local`), `LAB_LAB-ROUTER-01_API_BASE_URL=https://unifi.local`, TLS de confiança. | Chave API **nunca** no git; rodar se exposta. |
