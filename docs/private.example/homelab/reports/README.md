...
1. **Ações** → **Iniciar um programa**:
   ...
   - **Argumentos:** `-NoProfile -ExecutionPolicy Bypass -File "C:\Users\fabio\Documents\dev\python3-lgpd-crawler\scripts\snmp-udm-lab-probe-to-log.ps1" -WslDistro "Debian" -MaxLines 400`
   ...
   - **Começar em:** `C:\Users\fabio\Documents\dev\python3-lgpd-crawler` (raiz do clone).
