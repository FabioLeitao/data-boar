...
| 2026-03-23 | mini-bt  | **fail**                | skipped | Local change blocks merge: `scripts/homelab-host-report.sh` — stash or commit on host, then re-run |
| 2026-03-23 | pi3b     | **fail**                | skipped | Same as mini-bt                                                                                    |
