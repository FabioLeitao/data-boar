...
0. **Corporate-Entity-C backlog (token-aware, non-blocking)** — **W-KPI:** release/CI KPI view; **W-CONTRACT:** contract tests for Excel/OpenAPI critical paths (see [Corporate-Entity-C_ANALISE_2026-03-18.md](Corporate-Entity-C_ANALISE_2026-03-18.md)). Pick one small slice when maintenance is green.
