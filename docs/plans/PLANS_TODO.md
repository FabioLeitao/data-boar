...
| Doc snapshot per release                             | ✅ Baseline                     | `docs/releases/X.Y.Z.md` per version; **latest published golden: 1.7.2+safe** (`docs/releases/1.7.2-safe.md`, tag **`v1.7.2-safe`**, GitHub + Hub **2026-04-22**); prior **1.7.1** notes remain in `docs/releases/1.7.1.md`. Optional “frozen bundle” → backlog.                                                                                                                   |
...
**Next patch:** **`1.7.3`** when the next bundle ships (after **`v1.7.2-safe`** / **1.7.2+safe**).
