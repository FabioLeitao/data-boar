...
| Compliance standards alignment           | —                               | None           | Doc only: ISO 27701 (Colleague-KS), FELCA (minor data); COMPLIANCE_FRAMEWORKS + roadmap sentence; no code. See PLAN_COMPLIANCE_STANDARDS_ALIGNMENT. |
...
| ----- | ---- | ------------------------------ |
| 0 | **Compliance standards alignment (ISO 27701, FELCA)** | Doc only: COMPLIANCE_FRAMEWORKS + roadmap; no code; smallest scope; supports pitch and audit narrative. |
...
### Compliance standards alignment (ISO 27701, FELCA) – [PLAN_COMPLIANCE_STANDARDS_ALIGNMENT.md](PLAN_COMPLIANCE_STANDARDS_ALIGNMENT.md)
...
| 3 | Update roadmap sentence in README.md (ISO 27701, FELCA, auditable/regional standards).                 | ✅ Done   |
