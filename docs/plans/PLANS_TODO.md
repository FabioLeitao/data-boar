...
- **Next stable patch:** **`1.7.1`** (final, no suffix) when the bundle ships; **`main`** currently carries **`1.7.1-beta`** in **`pyproject.toml`** (pre-release — dashboard i18n + `enterprise_surface`; not the same baseline as published **1.7.0**). Follow **`docs/releases/`** + [VERSIONING.md](../VERSIONING.md).
...
| Doc snapshot per release                             | ✅ Baseline                     | `docs/releases/X.Y.Z.md` per version; **latest published stable: 1.7.0** (`docs/releases/1.7.0.md`); **pre-release notes:** [`docs/releases/1.7.1-beta.md`](../releases/1.7.1-beta.md) (in-repo semver on `main`); next **stable** bump when ready: **1.7.1**. Optional “frozen bundle” → backlog.                                                                                                                   |
...
**Next stable patch:** **`1.7.1`** when the bundle ships (after **1.7.0**); **`main`** may show **`1.7.1-beta`** until promotion per [VERSIONING.md](../VERSIONING.md).
