...
| **Backlog**     | Quasi-identification risk (IP+geo+breadcrumbs)                    | A/M                            | [PLAN_QUASI_IDENTIFICATION_COMPOSITE_RISK.md](PLAN_QUASI_IDENTIFICATION_COMPOSITE_RISK.md)                                                                       |
...
| **S2 – Detection depth**         | FN / hints        | One or two rows from FN plan (e.g. 5, 6, or 10–11) **or** one quasi-identification slice (composite risk scoring/report guardrails)—**not all**         | Config review on real data if needed                                | Implementation + tests + SENSITIVITY_DETECTION docs            |
...
| **M-QID**           | Quasi-identification risk controls active                      | Composite score + thresholds + explainable factors + redacted report output for IP+geo+breadcrumb combinations; safe defaults keep enrichment off unless explicitly enabled and bounded.                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
