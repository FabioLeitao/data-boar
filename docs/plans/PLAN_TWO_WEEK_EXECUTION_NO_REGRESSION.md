...
| **2** | **Open-core POC / beta readiness** | **`v1.7.2-safe`** ✅ golden — next patch **`1.7.3`**: pick **one** primary (**maturity POC ready** closure **or** first scope-import vendor adapter **or** small governance slice per [PLANS_TODO.md](PLANS_TODO.md)); optional **–1L** lab proof still operator-paced. |
