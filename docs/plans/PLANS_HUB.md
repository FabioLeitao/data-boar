...
| **Open** | [PLAN_LAB_OP_CAPEX_OPEX_AND_PROCUREMENT.md](PLAN_LAB_OP_CAPEX_OPEX_AND_PROCUREMENT.md) | Plan: Lab-OP CAPEX/OPEX & Procurement | Single tracked procurement spine for lab-op (priorities, rationale, risk gates, no real prices); private master keeps real costs and vendor details. | [PLAN_LAB_FIREWALL_ACCESS_AND_OBSERVABILITY.md](PLAN_LAB_FIREWALL_ACCESS_AND_OBSERVABILITY.md) [PLAN_LAB_OP_OBSERVABILITY_STACK.md](PLAN_LAB_OP_OBSERVABILITY_STACK.md) [PLAN_READINESS_AND_OPERATIONS.md](PLAN_READINESS_AND_OPERATIONS.md) |
...
| **Open** | [PLAN_QUASI_IDENTIFICATION_COMPOSITE_RISK.md](PLAN_QUASI_IDENTIFICATION_COMPOSITE_RISK.md) | Plan: Quasi-identification composite risk (IP + geolocation + breadcrumbs) | Add configurable composite-risk detection for quasi-identification in logs/proxy traces (IP+geo+breadcrumbs), with LGPD-first guardrails and safe default behavior. | [PLAN_ADDITIONAL_DETECTION_TECHNIQUES_AND_FN_REDUCTION.md](PLAN_ADDITIONAL_DETECTION_TECHNIQUES_AND_FN_REDUCTION.md) [PLAN_READINESS_AND_OPERATIONS.md](PLAN_READINESS_AND_OPERATIONS.md) [PLAN_COMPLIANCE_STANDARDS_ALIGNMENT.md](PLAN_COMPLIANCE_STANDARDS_ALIGNMENT.md) |
