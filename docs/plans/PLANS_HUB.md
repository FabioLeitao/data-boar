...
| **Open** | [PLAN_DASHBOARD_I18N.md](PLAN_DASHBOARD_I18N.md) | Dashboard i18n and multi-language web UI | **Status:** **Target architecture agreed**; **D-WEB** ✅. **Operator priority:** ship **M-LOCALE-V1** (path-prefixed HTML + `en` / `pt-BR`) **before** [#86](https://github.com/FabioLeitao/data-boar/issues/86) **Phase 1**  | — |
