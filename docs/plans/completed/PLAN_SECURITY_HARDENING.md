...
| #   | To-do                                                                                                                                                                        | Status     | Notes                                                                                          |
| --- | -------------------------------------------------------------------------------------------------------------------------------------                                        | ---------- | -----                                                                                          |
| 4.1 | **SSL/TLS (S4423):** Any use of `ssl.create_default_context()` must set `minimum_version = ssl.TLSVersion.TLSv1_2`. Enforced by test in `tests/test_sonarqube_python.py`.    | ✅ Done     | Guard enforced repo-wide by `tests/test_sonarqube_python.py` (S4423 scan).               |
