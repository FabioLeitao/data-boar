...
| **Backlog**      | Locale dashboard **M-LOCALE-V1** (implementação)                                  | A                                     | **D-WEB** ✅; **antes** da **Fase 1** do **#86**; [PLAN_DASHBOARD_I18N.md](PLAN_DASHBOARD_I18N.md)                                                                                                                                                            |
...
| 2     | **M-LOCALE-V1**                       | A    | **Próxima fatia de código** neste cluster: prefixo de locale + JSON `en` / `pt-BR` + cookie / `Accept-Language` / fallback — [PLAN_DASHBOARD_I18N.md](PLAN_DASHBOARD_I18N.md). **Antes** da linha 3. |
