...
**Colaboradores:** operador, Colleague-A (future), Colleague-B (future — fornecedor de dados sintéticos e ambiente de test)
...
### Fase 4 — Dados reais (com Colleague-A / Colleague-B — futuro)
