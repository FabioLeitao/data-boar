...
**Version signal for testers (do not rely on git inference alone):** **Published** golden line is **`v1.7.2-safe`** / Python **`1.7.2+safe`** (Hub / GitHub Release); **`main`** after publish may already show the next **`-beta`** ([VERSIONING.md](../VERSIONING.md)). Callouts: [CHANGELOG.md](../../CHANGELOG.md), [docs/releases/1.7.2-safe.md](../releases/1.7.2-safe.md), README **Current release**. Prior feature release notes: [docs/releases/1.7.1.md](../releases/1.7.1.md). For a frozen tree, **`git checkout v1.7.2-safe`** — not only `git log` on moving **`main`**.
