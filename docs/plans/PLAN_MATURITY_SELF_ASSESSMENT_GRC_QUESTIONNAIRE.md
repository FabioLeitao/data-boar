...
**Version signal for testers (do not rely on git inference alone):** in-repo semver on **`main`** at tag **`v1.7.2-safe`** is **`1.7.2+safe`** ([VERSIONING.md](../VERSIONING.md)); **published** golden line is **`v1.7.2-safe`** (Hub / GitHub Release). Callouts: [CHANGELOG.md](../../CHANGELOG.md), [docs/releases/1.7.2-safe.md](../releases/1.7.2-safe.md), README **Current release**. Prior feature release notes: [docs/releases/1.7.1.md](../releases/1.7.1.md). Anyone pulling `main` for **formal** testing should use those files—not only `git log`.
