...
| 3 | Update roadmap sentence in README.md (decision-makers / “Why it holds up”): mention alignment with ISO 27701 (Colleague-KS) and FELCA (minor-data mapping) documented; we continue to extend support for auditable and regional standards. | ✅ Done |
