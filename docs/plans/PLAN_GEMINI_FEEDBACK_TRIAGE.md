...
| **G-26-13** | **Wabbix** referred to ambiguously (entity gender / what it is) — align EN↔pt-BR. | Glossary or one-line definition in docs; match EN. | Cold | Clarity | **Mitigado (2026-04):** entrada **Wabbix / WRB** em **GLOSSARY.md** e **GLOSSARY.pt_BR.md** (seção 9), com link a **WABBIX_IN_REPO_BASELINE** e guideline — vocabulário de processo, não módulo do produto. |
