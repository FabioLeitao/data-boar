...
- **Compliance & glossary:** Expanded **GLOSSARY** (EN + pt-BR): **Stark Law**, **HCP**, **CPML** context, **HHS** vs **HSS**, **minor** data and risk, **Corporate-Entity-C/WRB**, **VBA** (*value-based agreement* vs Office **VBA**); **COMPLIANCE_AND_LEGAL** positioning (PEP/KYC, criminal-record context, joint delivery, HIPAA adjacency).
