...
**See also:** Documentation index (all topics, both languages): [README.md](README.md) · [README.pt_BR.md](README.pt_BR.md). [TOPOLOGY.md](TOPOLOGY.md) ([pt-BR](TOPOLOGY.pt_BR.md)) — application topology; [TECH_GUIDE.md](TECH_GUIDE.md) · [TECH_GUIDE.pt_BR.md](TECH_GUIDE.pt_BR.md); [TESTING.md](TESTING.md) ([pt-BR](TESTING.pt_BR.md)); [COMMIT_AND_PR.md](COMMIT_AND_PR.md) ([pt-BR](COMMIT_AND_PR.pt_BR.md)); [COMPLIANCE_FRAMEWORKS.md](COMPLIANCE_FRAMEWORKS.md) ([pt-BR](COMPLIANCE_FRAMEWORKS.pt_BR.md)).
