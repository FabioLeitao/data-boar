...
| ---- | ------ | ------ | ----- |
| **1.6.9 prep + Corporate-Entity-C-ready gates (Dependabot → CodeQL → Sonar? → Scout → check-all)** | [OPERATOR_TODAY_MODE_2026-04-16.md](OPERATOR_TODAY_MODE_2026-04-16.md) | ⬜ Pending | **`maintenance-check.ps1`**; **#188** merged (session 2026-04-16); **CodeQL** errors; **SonarQube** if lab up; **Scout** + **`docker-scout-critical-gate`**; **`check-all`**; features + WRB per [Corporate-Entity-C_REVIEW_REQUEST_GUIDELINE.md](../Corporate-Entity-C_REVIEW_REQUEST_GUIDELINE.md) — [PUBLISHED_SYNC.md](PUBLISHED_SYNC.md) |
