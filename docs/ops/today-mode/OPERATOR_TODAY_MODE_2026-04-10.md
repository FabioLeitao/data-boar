...
- [ ] **Ansible / USAGE / LAB-NODE-01 / `uv`:** items from **2026-04-06** still valid — see **`OPERATOR_TODAY_MODE_2026-04-06.md`** for the full table.
...
- [ ] **Corporate-Entity-C WRB** e-mail — paste block: latest **`WRB_DELTA_SNAPSHOT_*.md`**
