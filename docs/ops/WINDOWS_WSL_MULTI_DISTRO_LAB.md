...
- **Extra WSL distros** = **compatibility confidence** and **practice** for [§9](HOMELAB_VALIDATION.md#9-multi-host-linux-optional-matrix-dns-ssh-different-distros); they **do not** replace **real** second hardware (LAB-NODE-02, Pi, Proxmox guest) for **NIC/firewall/Swarm** behaviour.
