...
- Operator homelab context (e.g. **lab-node-02** / Zorin): private **`docs/private/homelab/LAB_SECURITY_POSTURE.md`** §2 (UFW, Lynis, AppArmor mentions)—**not** a substitute for this runbook.
