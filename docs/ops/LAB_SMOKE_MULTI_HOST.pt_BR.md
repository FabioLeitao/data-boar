...
| **sshfs** | Montar diretório remoto na **latitude** (ou **WSL2** no PC de desenvolvimento), depois `path:` no mount. Latência aumenta o tempo de scan — aceitável em laboratório. |
