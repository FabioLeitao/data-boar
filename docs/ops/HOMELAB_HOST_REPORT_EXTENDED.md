...
### Class: mini-bt (Void, x86_64, SATA SSD, “utility box”)
...
### Class: Latitude (Ubuntu-family desktop/server, SATA SSD, Docker Swarm manager)
...
### Class: T14 (LMDE, NVMe, encrypted BTRFS workstation)
