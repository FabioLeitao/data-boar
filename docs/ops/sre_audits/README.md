...
| Date       | Audit                                                                                                              | Scope                                                              |
| :--------- | :----------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------- |
| 2026-04-28 | [`BRANCH_HYGIENE_RCA_2026-04-28.md`](BRANCH_HYGIENE_RCA_2026-04-28.md)                                             | RCA for `git branch -r` screen-bloat: 40 of 41 remote refs back live OPEN PRs; truly orphan set was `{fix-rust-ci-coverage-9061}`. Ships read-only `scripts/git-list-remote-orphan-branches.{sh,ps1}` lister; surfaces but does not delete. |
