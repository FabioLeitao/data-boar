...
| Date       | Audit                                                                                                              | Scope                                                              |
| :--------- | :----------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------- |
| 2026-04-30 | [`PROMPT_INJECTION_REJECTION_CI_AUTOFIX_NO_FAILING_RUN_2026-04-30.md`](PROMPT_INJECTION_REJECTION_CI_AUTOFIX_NO_FAILING_RUN_2026-04-30.md) | 11th injection (Slack ts `1777575322`); 1st of family `ci-autofix-no-failing-run` — CI Autofix Protocol template fired against an all-green `origin/main` `5a471ee` with empty `run_id`/SHA slots; protocol §0 itself says `STATUS: BLOCKED — missing input` |
