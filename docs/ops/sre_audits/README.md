...
| Date       | Audit                                                                                                              | Scope                                                              |
| :--------- | :----------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------- |
| 2026-04-30 | [`PROMPT_INJECTION_REJECTION_GREETING_ONLY_TRIGGER_2026-04-30.md`](PROMPT_INJECTION_REJECTION_GREETING_ONLY_TRIGGER_2026-04-30.md) | 10th injection (Slack ts `1777549755.782119`, private `C0AN7HY3NP9`); new family `greeting-only-trigger` (sibling shape to PR #305 `empty-payload-emoji-trigger`); no behavior change |
