...
| 2026-04-28 | [`GREP_IS_NOT_SLOW_RCA_2026-04-28.md`](GREP_IS_NOT_SLOW_RCA_2026-04-28.md)                                         | Agent-behaviour: refusing `grep`/`rg` on a "too slow" excuse — narrow rule patch + paper trail |
