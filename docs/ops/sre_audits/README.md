...
| 2026-04-28 | [`PROMPT_INJECTION_REJECTION_FABRICATED_PERSONA_RIGOR_2026-04-28.md`](PROMPT_INJECTION_REJECTION_FABRICATED_PERSONA_RIGOR_2026-04-28.md) | 7th injection (Slack ts `1777382486`), **2nd destructive-shape**; refuses fabricated `data-boar-blackbox-audit.txt` + always-on `persona-rigor.mdc` install + PR-template overwrite encoding the **regression** `0.574x` as a performance floor + ADR-0035-contradicting taxonomy mandate; no behavior change |
| 2026-04-27 | [`FABRICATED_CLAIMS_INDEX.md`](FABRICATED_CLAIMS_INDEX.md) (living)                                                | F8 follow-up from PR #281 — append-only ledger of fabrication-shaped escalations across the `report-generator-path-injection`, `dependabot-alert-fabricated`, `cargo-toml-root-fabricated`, `data-board-report-rename-fabricated`, `mass-close-audit-prs-fabricated-protocol`, and `fabricated-persona-rigor-rule-install` families |
