...
| 2026-04-27 | [`FABRICATED_CLAIMS_INDEX.md`](FABRICATED_CLAIMS_INDEX.md) (living)                                                | F8 follow-up from PR #281 — append-only ledger of fabrication-shaped escalations across the `report-generator-path-injection`, `dependabot-alert-fabricated`, `cargo-toml-root-fabricated`, `data-board-report-rename-fabricated`, `unique-pr-protocol-mass-close`, and `vapor-preamble-cockpit-infra` families |
| 2026-04-28 | [`PROMPT_INJECTION_REJECTION_VAPOR_COCKPIT_PREAMBLE_2026-04-28.md`](PROMPT_INJECTION_REJECTION_VAPOR_COCKPIT_PREAMBLE_2026-04-28.md) | 7th injection (Slack ts `1777382654.185479`); first **vapor-shape** escalation — "*NASA cockpit / Mission Rigor / Terminal de Telemetria de Engenharia*" preamble with no concrete target; documents PR #293 / PR #294 as parallel-agent vapor responses on the same trigger |
