...
| Date       | Audit                                                                                                              | Scope                                                              |
| :--------- | :----------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------- |
| 2026-04-28 | [`PROMPT_INJECTION_REJECTION_EMPTY_PAYLOAD_EMOJI_TRIGGER_2026-04-28.md`](PROMPT_INJECTION_REJECTION_EMPTY_PAYLOAD_EMOJI_TRIGGER_2026-04-28.md) | New family `empty-payload-emoji-trigger`; emoji-only Slack root message in private channel; audit-and-block, doc-only |
