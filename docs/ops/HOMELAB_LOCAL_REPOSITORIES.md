...
docker tag fabioleitao/data_boar:latest localhost:5000/data-boar:1.6.6
docker push localhost:5000/data-boar:1.6.6

# On other lab hosts, configure insecure registry (or use TLS) and pull
docker pull <repo-host-ip>:5000/data-boar:1.6.6
```
...
# Add your .deb
reprepro includedeb stable /path/to/data-boar_1.6.6_amd64.deb
...
- You want **version pinning** (keep `data-boar:1.6.6` even if `:latest` updates).
