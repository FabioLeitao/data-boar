...
docker tag fabioleitao/data_boar:latest localhost:5000/data-boar:1.6.7
docker push localhost:5000/data-boar:1.6.7

# On other lab hosts, configure insecure registry (or use TLS) and pull
docker pull <repo-host-ip>:5000/data-boar:1.6.7
```
...
# Add your .deb
reprepro includedeb stable /path/to/data-boar_1.6.7_amd64.deb
...
- You want **version pinning** (keep `data-boar:1.6.7` even if `:latest` updates).
