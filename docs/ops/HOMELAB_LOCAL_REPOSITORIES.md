...
docker tag fabioleitao/data_boar:latest localhost:5000/data-boar:1.7.1
docker push localhost:5000/data-boar:1.7.1

# On other lab hosts, configure insecure registry (or use TLS) and pull
docker pull <repo-host-ip>:5000/data-boar:1.7.1
```
...
# Add your .deb
reprepro includedeb stable /path/to/data-boar_1.7.1_amd64.deb
...
- You want **version pinning** (keep `data-boar:1.7.1` even if `:latest` updates).
