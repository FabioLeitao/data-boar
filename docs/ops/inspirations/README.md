...
- [Supply Colleague-Nn and trust signals](SUPPLY_Colleague-NN_AND_TRUST_SIGNALS.md) ([pt-BR — follow-ups adiados](SUPPLY_Colleague-NN_AND_TRUST_SIGNALS.pt_BR.md))
