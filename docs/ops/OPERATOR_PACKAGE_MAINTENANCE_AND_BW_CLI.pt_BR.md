...
**Nao** existe pacote `bitwarden-cli` nos repositorios padrao do Void. Instale **Node** + **npm** com `xbps` e depois o pacote npm oficial (mesma ideia do role Ansible **`lab-node-01_bitwarden_cli`** no Debian):
