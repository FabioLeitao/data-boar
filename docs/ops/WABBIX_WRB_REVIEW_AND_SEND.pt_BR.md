...
2. **Guardar no repositório** o mesmo conteúdo: atualizar o bloco “Prompt mestre completo” em [`Corporate-Entity-C_REVIEW_REQUEST_GUIDELINE.md`](Corporate-Entity-C_REVIEW_REQUEST_GUIDELINE.md) e, se usar este pacote, a seção §2 abaixo; fazer **`git commit`** para não perder o rascunho se a sessão ou o histórico sumirem.
