...
| Índice de keywords de sessão + SSH LAB-OP (`lab-node-02`)                | [OPERATOR_SESSION_SHORTHANDS.md](OPERATOR_SESSION_SHORTHANDS.md)                                 | [OPERATOR_SESSION_SHORTHANDS.pt_BR.md](OPERATOR_SESSION_SHORTHANDS.pt_BR.md)                                 |
| Cadência de verificação de PII (short/mid/long + gate manual)         | [PII_VERIFICATION_RUNBOOK.md](PII_VERIFICATION_RUNBOOK.md)                                       | [PII_VERIFICATION_RUNBOOK.pt_BR.md](PII_VERIFICATION_RUNBOOK.pt_BR.md)                                       |
