...
| Protocolo de auditoria de integridade (Rust, LCM pt-BR, benchmark / ADR de regressão) | [AUDIT_PROTOCOL.md](AUDIT_PROTOCOL.md) | [AUDIT_PROTOCOL.pt_BR.md](AUDIT_PROTOCOL.pt_BR.md) |
