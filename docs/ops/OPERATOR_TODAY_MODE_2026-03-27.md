...
- Open **[OPERATOR_TODAY_MODE_2026-03-26.md](OPERATOR_TODAY_MODE_2026-03-26.md)** — anything still unchecked (e.g. **tag `v1.6.7` + GitHub Release + Docker**, **Corporate-Entity-C WRB**, optional **branch protection**) either **do today**, **move to one PLANS row / issue**, or **defer explicitly** with a date — don’t leave it **dangling forever**.
...
| **0** Carryover + Slack | Operator | [OPERATOR_TODAY_MODE_2026-03-26.md](OPERATOR_TODAY_MODE_2026-03-26.md) (tag **v1.6.7**, Corporate-Entity-C, Slack mobile/desktop proof) — still manual. |
