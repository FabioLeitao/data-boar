...
- **Software / toolColleague-Nns (LAB‑OP):** extend **`OPERATOR_SYSTEM_MAP.md` §4** (and **`WHAT_TO_SHARE`** toolColleague-Nn table on WORKSTATION) when you add **Selenium**, extra **Python extras**, lab browsers, etc. — **no** secrets in files.
