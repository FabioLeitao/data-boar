...
3. **Loop Corporate-Entity-C:** responder com **evidências** (caminhos em `Corporate-Entity-C_IN_REPO_BASELINE.md`); escolher **uma** linha seguinte na tabela evolutiva como fatia **`feature`** ou **`backlog`** bem definida.
