...
- Abre **[OPERATOR_TODAY_MODE_2026-03-26.pt_BR.md](OPERATOR_TODAY_MODE_2026-03-26.pt_BR.md)** — o que ainda não estiver feito (ex.: **tag `v1.6.7` + GitHub Release + Docker**, **e-mail Corporate-Entity-C WRB**, **branch protection** opcional) ou **fazes hoje**, ou **passas para uma linha no PLANS / issue**, ou **adias com data explícita** — não deixes **sem dono para sempre**.
