...
| **EU (DSA Art. 28 + EUDI Wallet age attestation)** | [compliance-sample-eu_age_verification.yaml](compliance-samples/compliance-sample-eu_age_verification.yaml) | EU age-assurance **technical mapping** — DSA Art. 28 minor protection + EUDI Wallet age attestation (eIDAS 2.0); **not** age verification or legal advice. |
