...
- **ISO/IEC 27701 (PIMS):** ISO 27701 requires PII controllers and processors to know where PII is and to document the scope of processing. Our scans and reports (findings, norm tags, Excel output) help you produce that evidence and align with the regulations you declare under ISO 27701 (e.g. LGPD, GDPR, CCPA). See [PLAN_COMPLIANCE_STANDARDS_ALIGNMENT.md](plans/PLAN_COMPLIANCE_STANDARDS_ALIGNMENT.md).
