...
| **U.S. (H.R. 8250 — Parents Decide Act, pre-enactment)** | [compliance-sample-us_hr8250_parents_decide.yaml](compliance-samples/compliance-sample-us_hr8250_parents_decide.yaml) | U.S. **H.R. 8250** (119th Congress, *introduced — not enacted*) and companion *App Store Accountability Act* — **technical lexicon** for parental-consent records, OS-level age signals, app-store age gates, and device-to-guardian linkage. **Not** age verification, **not** parental-consent enforcement, **not** legal sign-off. |
