...
| 0044  | [Cloud automations on Data Boar must not spawn Task subagents while the platform whitelist is `composer-2-fast` only](0044-cloud-automations-no-subagents-while-only-composer-fast-whitelisted.md) | Accepted |
