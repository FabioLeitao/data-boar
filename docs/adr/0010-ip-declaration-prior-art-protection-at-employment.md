...
The operator (Fabio Tavares Leitão) accepted a CLT employment offer at **Corporate-Entity-B Payments**
...
Corporate-Entity-B Payments offer. The question was: how to ensure Data Boar's IP remains with the operator
...
1. Send a **formal IP Declaration** to the Corporate-Entity-B Payments responsible (Anthony Hawk,
   `ahawk@Corporate-Entity-B.com`) **before** the employment contract takes effect, explicitly declaring
...
- **Negative:** A formal declaration is not a substitute for legal review. If Corporate-Entity-B's contract
...
- `docs/private/homelab/OPERATOR_RETEACH.md` §C (Corporate-Entity-B employment context — gitignored)
