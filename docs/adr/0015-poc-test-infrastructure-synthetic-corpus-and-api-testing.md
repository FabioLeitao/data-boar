...
4. **Reproducibility** — collaborators (IDENTIDADE_COLABORADOR_A, IDENTIDADE_COLABORADOR_B) must run the same test pass independently and get comparable results.
