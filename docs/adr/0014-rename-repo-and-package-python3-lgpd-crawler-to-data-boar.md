...
| Collaborator clone remotes (Contributor-A) | lgpd-crawler.git | data-boar.git (one command) |
...
- Contributor-A's clone remote needs one manual update: `git remote set-url origin git@github.com:FabioLeitao/data-boar.git`
...
- [ ] Notify Contributor-A with: `git remote set-url origin git@github.com:FabioLeitao/data-boar.git`
