...
> **Audience:** POC testers, collaborators (Talita, Felipe), operators.
...
# or Docker:
docker run -p 8088:8088 -v \C:\Users\fabio\Documents\dev\python3-lgpd-crawler/config.yaml:/data/config.yaml fabioleitao/data_boar:latest
```
