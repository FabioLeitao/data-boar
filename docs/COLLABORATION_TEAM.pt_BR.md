...
| Artefato | Função |
| -------- | ------ |
| **[`AGENTS.md`](../AGENTS.md)** | Contrato global do assistente: idioma, segredos, homelab, Git/PR, testes. **Ambos** devem ler uma vez; o Contributor-A segue o mesmo arquivo ao clonar. |
