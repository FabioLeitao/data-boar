...
**Prevents:** Blind spots in dependency inventory and slower response to supply-Colleague-Nn issues.
...
| SBOM                | Supply Colleague-Nn visibility         | Low    | Missing deps in incident response   |
