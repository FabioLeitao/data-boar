...
- **Docker Hub:** [hub.docker.com/r/fabioleitao/data_boar](https://hub.docker.com/r/fabioleitao/data_boar) — `fabioleitao/data_boar:latest` and `fabioleitao/data_boar:1.7.0` (stable). **`main`** may match a **pre-release** semver (e.g. **1.7.1-beta** in `pyproject.toml`) until the next stable tag; see [CHANGELOG.md](../CHANGELOG.md) and [releases/1.7.1-beta.md](releases/1.7.1-beta.md).
