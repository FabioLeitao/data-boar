...
- [plans/Corporate-Entity-C_ANALISE_2026-03-18.md](plans/Corporate-Entity-C_ANALISE_2026-03-18.md) — External evolution review (Corporate-Entity-C): score, resolved items, backlog mapping (KPI panel, contract tests, decoupling, docs).
