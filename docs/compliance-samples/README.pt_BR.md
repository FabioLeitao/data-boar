...
| **compliance-sample-us_hr8250_parents_decide.yaml** | EUA **H.R. 8250** (Parents Decide Act, 119º Congresso — *introduzido, não promulgado*) + companion *App Store Accountability Act*: léxico técnico para registros de **consentimento parental**, **age signals** de OS, **age gates** em app stores e vínculo **dispositivo → responsável**. Combine com COPPA / CAADCA / CO CPA-menores. **Não** faz verificação de idade, **não** impõe consentimento parental. |
