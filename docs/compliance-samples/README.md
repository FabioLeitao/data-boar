...
| **compliance-sample-us_hr8250_parents_decide.yaml** | U.S. **H.R. 8250** (Parents Decide Act, 119th Congress — *introduced, not enacted*) + companion *App Store Accountability Act*: technical lexicon for **parental-consent records**, **OS-level age signals**, **app-store age gates**, and **device-to-guardian linkage**. Pair with COPPA / CAADCA / CO CPA minors samples. **Not** age verification, **not** parental-consent enforcement. |
