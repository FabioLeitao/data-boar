...
- [plans/WABBIX_ANALISE_2026-03-18.md](plans/WABBIX_ANALISE_2026-03-18.md) — Revisão externa de evolução (Wabbix): nota, itens resolvidos, mapeamento do backlog (painel de KPI, testes de contrato, desacoplamento, documentação).
