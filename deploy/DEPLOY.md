...
To use a version tag as well (e.g. `1.1.0`):

```bash
docker tag fabioleitao/python3-lgpd-crawler:latest fabioleitao/python3-lgpd-crawler:1.1.0
docker push fabioleitao/python3-lgpd-crawler:1.1.0
```
...
Optional: tag and push a version (e.g. `1.1.0`): `docker tag fabioleitao/python3-lgpd-crawler:latest fabioleitao/python3-lgpd-crawler:1.1.0` then `docker push fabioleitao/python3-lgpd-crawler:1.1.0`. See also `DOCKER_SETUP.md`.
