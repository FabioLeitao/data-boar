...
> **Current release:** **1.7.2+safe** (PEP 440). **Docker Hub:** **`fabioleitao/data_boar:v1.7.2-safe`** or **`latest`**. Summary: [CHANGELOG.md](CHANGELOG.md). Full notes: [docs/releases/1.7.2-safe.md](docs/releases/1.7.2-safe.md) and the [GitHub Releases page](https://github.com/FabioLeitao/data-boar/releases).
