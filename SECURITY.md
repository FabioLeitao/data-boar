...
Formal **CycloneDX JSON** SBOMs support **supply-Colleague-Nn** visibility and **incident response** (see [docs/adr/0003](docs/adr/0003-sbom-roadmap-cyclonedx-then-syft.md)). They complement **`pip-audit`**; they are **not** organizational risk management under ISO 31000 (see [COMPLIANCE_FRAMEWORKS.md](docs/COMPLIANCE_FRAMEWORKS.md)).
