...
description: When the operator chats in Portuguese, the assistant uses Brazilian Portuguese (pt-BR) in replies—same bar as docs-pt-br-locale—not European Portuguese; English is fine for commands, brands, and technical jargon.
---
...
- **Portuguese:** **Brazilian (pt-BR)** only in prose — aligned with **`.cursor/rules/docs-pt-br-locale.mdc`** and **`*.pt_BR.md`** (no *ficheiro*, *partilhar*, *secção*, *utilizador*, *tem de*, etc.).
