...
- Tasks that open **Patreon, LinkedIn, X, YouTube, Threads**, **Instagram**, or other third-party UIs in the **Cursor embedded browser** (MCP `cursor-ide-browser`).
