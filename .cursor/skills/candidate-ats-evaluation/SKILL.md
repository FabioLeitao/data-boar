...
.\scripts\talent.ps1 import "Contributor-A.pdf"
.\scripts\talent.ps1 import "Linked in Profile - Pedro 2026.pdf"

# ABRE ATS de um candidato no editor (aceita apelido do pool)
.\scripts\talent.ps1 review contributor-a
.\scripts\talent.ps1 review pedro
.\scripts\talent.ps1 review andre_Colleague-H

# ABRE LinkedIn no browser
.\scripts\talent.ps1 linkedin contributor-a
.\scripts\talent.ps1 linkedin colleague-a
...
.\scripts\talent.ps1 extract "Contributor-A.pdf"
```
...
docs/private/commercial/candidates/linkedin_peer_review/
  ...
  individual/
    Contributor-A_Contributor-A_ATS.pt_BR.md                         # Por candidato
    PEDRO_Colleague-F_Colleague-G_ATS.pt_BR.md
    ANDRE_Colleague-H_SANTOS_ATS.pt_BR.md
    ...
...
**Nome completo:** ...
**LinkedIn:** https://www.example.com/profile/redacted
**Email:** ...@...
...
| Apelido | Nome Real |
|---|---|
| contributor-a | Collaborator-A |
| pedro | Collaborator-D |
| andre_Colleague-H | Collaborator-C S. dos Santos |
| andre_Colleague-I | Collaborator-H |
| aca | Collaborator-L |
| braga | Collaborator-M |
| caterine | Collaborator-N |
| Colleague-J | Collaborator-E |
| Colleague-S | Collaborator-O |
| Colleague-C | Collaborator-F |
| freire | Collaborator-P |
| freitas | Collaborator-Q |
| Colleague-P | Collaborator-R |
| irlan | Collaborator-S |
| madruga | Collaborator-T |
| marcos | Collaborator-U |
| Colleague-D | Collaborator-J |
| Colleague-T | Collaborator-I |
| Colleague-K | Collaborator-K |
| Colleague-U_gomez | Collaborator-V |
| Colleague-U_Colleague-V | Collaborator-W |
...
**Bitwarden:** Para credenciais do LAB-ROUTER-01 e outras - habilitar via:
...
bw login
# Buscar secret
bw get password "LAB-ROUTER-01 auto.cursor"
```

**Arquivo .env para credenciais locais (gitignored):**

```
docs/private/homelab/.env.api.LAB-ROUTER-01-se.local  # API key LAB-ROUTER-01 (ja existe)
docs/private/homelab/.env.LAB-ROUTER-01.cursor        # senha auto.cursor (criar quando necessario)
```
