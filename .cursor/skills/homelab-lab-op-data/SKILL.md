...
- LAB-ROUTER-01: scan de rede, clientes, VLANs, alertas, configuracoes
...
```powershell
Get-ChildItem docs/private/homelab/reports/LAB-ROUTER-01_api_*.json | Sort LastWriteTime -Desc | Select -First 1
```
...
.\scripts\LAB-ROUTER-01.ps1 -Command scan -Out "docs/private/homelab/reports/LAB-ROUTER-01_api_$(Get-Date -Format yyyyMMdd_HHmmss).json"

# Com API key direta (temporario):
.\scripts\LAB-ROUTER-01.ps1 -Command clients -ApiKey $env:LAB_LAB-ROUTER-01_API_KEY
```
...
- `ports` -- portas do switch integrado LAB-ROUTER-01-SE
...
# 2. Scan LAB-ROUTER-01
.\scripts\LAB-ROUTER-01.ps1 -Command scan -Out "docs/private/homelab/reports/LAB-ROUTER-01_api_$(Get-Date -Format yyyyMMdd).json"
...
- `docs/private/homelab/reports/*.json` -- snapshots LAB-ROUTER-01 (nunca commitar)
